    ...
    <>
      <div className="w-full flex justify-between items-center font-semibold">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="https://play.google.com/store/apps/details?id=com.spotify.music&pcampaignid=web_share" target="_blank" className="bg-black py-1 px-3 rounded-2xl text-[15px] cursor-pointer">
            Install App
          </a>
